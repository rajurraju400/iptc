...
- The HP Blade servers support a maximum of 48 vCPUs. Due to this constraint, the NCD Git component cannot be deployed on the Hub cluster as per the standard blueprint. 
  - Instead, a lightweight (minion) GitHub instance is deployed on the infra-manager (utility) node.
